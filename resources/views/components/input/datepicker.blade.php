        ...
        <div class="mb-5">
            ...
            <div class="relative">
                ...
                <input type="text" x-on:click="initDate(datepickerValue), showDatepicker = !showDatepicker"
                    x-model="datepickerValue" x-on:keydown.escape="showDatepicker = false" {{-- class="w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" --}}
                    class="input input-bordered" placeholder="Select date" />
                            ...
                            <div style="width: 14.28%" class="px-1 mb-1">
                                <div @click="getDateValue(date)" x-text="date"
                                    ...
                                    :class="{
                                        ...
                                        'text-gray-600 hover:bg-primary': isToday(date) == false && isSelectedDate(
                                            date) == false,
